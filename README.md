#inHerito (A brainfart on solving overinheritance with mixins) [![Build Status](https://travis-ci.org/Ositoozy/inherito.svg?branch=master)](https://travis-ci.org/Ositoozy/inherito)
